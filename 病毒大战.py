...
class Score():
    ...
    def ShowScore(self):
        ...
        # score_text = score_font.render("Score : {0}".format(score), True, WHITE)
...
# 游戏界面标题
pygame.display.set_caption('病毒大作战')
# 背景图
background = pygame.image.load('image1/background.jpg').convert()
# Game Over的背景图
game_over = pygame.image.load('image1/background.jpg')
# 飞机图片集合
# 设置玩家飞机不同状态的图片列表，多张图片展示为动画效果
player_img1 = pygame.image.load('image1/player.png')  # 正常玩家绿色状态
player_img2 = pygame.image.load('image1/player.png')
p_img1 = pygame.image.load('image1/player2.png')  # 病毒爆炸状态
p_img2 = pygame.image.load('image1/player2.png')
p_img3 = pygame.image.load('image1/player2.png')
plane_img = []
plane_img.append(player_img1.subsurface(pygame.Rect(0, 0, 22, 99)).convert_alpha())
plane_img.append(player_img2.subsurface(pygame.Rect(0, 0, 22, 99)).convert_alpha())
plane_img.append(p_img1.subsurface(pygame.Rect(0, 0, 20, 90)).convert_alpha())  # 针管爆炸状态  （红色）
plane_img.append(p_img2.subsurface(pygame.Rect(0, 0, 20, 90)).convert_alpha())
plane_img.append(p_img3.subsurface(pygame.Rect(0, 0, 20, 90)).convert_alpha())
player_pos = [200, 500]  # 玩家飞机的初始位置
# 子弹图片
b_img = pygame.image.load('image/playerbullet.png')
bullet_rect = pygame.Rect(0, 0, 20, 25)
bullet_img = b_img.subsurface(bullet_rect)
# 敌机不同状态的图片列表，多张图片展示为动画效果
e_img1 = pygame.image.load('image1/eplane1.png')
e_img1 = pygame.transform.smoothscale(e_img1,(50,34))
e_img2 = pygame.image.load('image1/eplane2.png')
e_img2 = pygame.transform.smoothscale(e_img2,(50,34))
e_img3 = pygame.image.load('image1/eplane3.png')
e_img3 = pygame.transform.smoothscale(e_img3,(50,34))
e_img4 = pygame.image.load('image1/eplane4.png')
e_img4 = pygame.transform.smoothscale(e_img4,(50,34))
...
# 载入糖果图片
c1_img = pygame.image.load('image/sugar.png')
# 存储多个糖果
...
while running:
    ...
    # 首先判断玩家飞机没有被击中
    if not player.is_hit:
        if shoot_frequency % 10 == 0 and key_pressed[K_SPACE]:
    ...
    for candy in candies:
        ...
        if pygame.sprite.collide_circle(candy, player):
            ...
            gamescore.AddScore(10)  # 击中糖果加分10
            continue
        # 移动出屏幕后删除糖果
        if candy.rect.top < 0:
